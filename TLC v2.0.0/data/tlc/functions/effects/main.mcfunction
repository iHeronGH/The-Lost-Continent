...
execute if entity @a[tag=eoflib.atts, predicate=tlc:tribes/hivewings] run function tlc:effects/hivewings/base
execute if entity @a[tag=eoflib.atts, predicate=tlc:tribes/leafwings] run function tlc:effects/leafwings/base
execute if entity @a[tag=eoflib.atts, predicate=tlc:tribes/silkwings] run function tlc:effects/silkwings/base
