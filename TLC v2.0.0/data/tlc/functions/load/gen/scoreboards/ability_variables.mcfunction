...
execute store result score #tlc.abilities.acid_spray.cooldown tlc.abilities.acid_spray run data get storage eoflib:config tlc.Abilities[].HiveWings.primary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.acid_spray.duration Sets the duration for Acid Spray.
execute store result score #tlc.abilities.acid_spray.duration tlc.abilities.acid_spray run data get storage eoflib:config tlc.Abilities[].HiveWings.primary[0].eof_data.ability_data.duration 20
...
execute store result score #tlc.abilities.silk_shot.cooldown tlc.abilities.silk_shot run data get storage eoflib:config tlc.Abilities[].SilkWings.primary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.silk_shot.duration Sets the duration for Silk Shot.
execute store result score #tlc.abilities.silk_shot.duration tlc.abilities.silk_shot run data get storage eoflib:config tlc.Abilities[].SilkWings.primary[0].eof_data.ability_data.duration 20
...
execute store result score #tlc.abilities.hive_mind.cooldown tlc.abilities.hive_mind run data get storage eoflib:config tlc.Abilities[].HiveWings.secondary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.hive_mind.duration Sets the duration for Hive Mind.
execute store result score #tlc.abilities.hive_mind.duration tlc.abilities.hive_mind run data get storage eoflib:config tlc.Abilities[].HiveWings.secondary[0].eof_data.ability_data.duration 20
...
execute store result score #tlc.abilities.leafspeak.cooldown tlc.abilities.leafspeak run data get storage eoflib:config tlc.Abilities[].LeafWings.secondary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.leafspeak.duration Sets the duration for Leafspeak.
execute store result score #tlc.abilities.leafspeak.duration tlc.abilities.leafspeak run data get storage eoflib:config tlc.Abilities[].LeafWings.secondary[0].eof_data.ability_data.duration 20
...
scoreboard players operation #tlc.abilities.leafspeak.duration_end tlc.abilities.leafspeak -= #tlc.abilities.leafspeak.duration tlc.abilities.leafspeak
            ...
            ### Metamorphosis
#define score_holder #tlc.abilities.metamorphosis.cooldown Sets the cooldown for Metamorphosis.
execute store result score #tlc.abilities.metamorphosis.cooldown tlc.abilities.metamorphosis run data get storage eoflib:config tlc.Abilities[].SilkWings.secondary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.metamorphosis.duration Sets the duration for Metamorphosis.
execute store result score #tlc.abilities.metamorphosis.duration tlc.abilities.metamorphosis run data get storage eoflib:config tlc.Abilities[].SilkWings.secondary[0].eof_data.ability_data.duration 20

#define score_holder #tlc.abilities.metamorphosis.duration_end Calculates the scoreboard value for when the maximum duration for Metamorphosis has occurred.
scoreboard players operation #tlc.abilities.metamorphosis.duration_end tlc.abilities.metamorphosis = #tlc.abilities.metamorphosis.cooldown tlc.abilities.metamorphosis
scoreboard players operation #tlc.abilities.metamorphosis.duration_end tlc.abilities.metamorphosis -= #tlc.abilities.metamorphosis.duration tlc.abilities.metamorphosis
...
execute store result score #tlc.abilities.sting_strike.duration tlc.abilities.sting_strike run data get storage eoflib:config tlc.Abilities[].HiveWings.tertiary[0].eof_data.ability_data.duration 20
...
execute store result score #tlc.abilities.venom_aura.cooldown tlc.abilities.venom_aura run data get storage eoflib:config tlc.Abilities[].LeafWings.tertiary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.venom_aura.duration Sets the duration for Venom Aura.
execute store result score #tlc.abilities.venom_aura.duration tlc.abilities.venom_aura run data get storage eoflib:config tlc.Abilities[].LeafWings.tertiary[0].eof_data.ability_data.duration 20
...
execute store result score #tlc.abilities.webbing.cooldown tlc.abilities.webbing run data get storage eoflib:config tlc.Abilities[].SilkWings.tertiary[0].eof_data.ability_data.cooldown 20

#define score_holder #tlc.abilities.webbing.duration Sets the duration for Webbing.
execute store result score #tlc.abilities.webbing.duration tlc.abilities.webbing run data get storage eoflib:config tlc.Abilities[].SilkWings.tertiary[0].eof_data.ability_data.duration 20
